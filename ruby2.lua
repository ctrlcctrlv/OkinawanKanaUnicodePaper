...
SILE.registerCommand("ruby", function (options, content)
  ...
  local rubyHeightm = SILE.measurement(rubyHeight)
  ...
  rubybox.outputYourself = function (self, typesetter, line)
    ...
    typesetter.frame:advancePageDirection(-rubyHeightm)
  ...
  cbox.height = (rubyHeightm:absolute())
